...
@section('content')
    <main id="main" class="">
        ...
        <div class="tg-page-wrapper tg-haslayout">
            <div class="container">
                    ...
                    <div class="main-page-wrapper tg-haslayout">
                        <div class="fw-page-builder-content">
                            <section
                                    ...
                                    style="margin-top: -100px; position: relative; left: -96px; box-sizing: border-box; width: 1162px; background-size: cover; background-position: 0% 100%; background-repeat: no-repeat;">
                            ...
                            <section class="tg-main-section haslayout  default"
                                     style="padding-top:0px;padding-bottom:0px;background-repeat:no-repeat;background-position:0% 100%; background-size: cover;">
                                <div class="builder-items">
                                                            ...
                                                            <div class="tg-displaytable">
                                                                ...
                                                                <div class="tg-displaytablecell">
                                                                    <div class="tg-box">
                                                                        ...
                                                                        <img src="//themographics.com/wordpress/docdirect/wp-content/uploads/2016/03/contact-us.png"
                                                                             alt="CONTACT INFO"> <span class="service-list">123 Eccles Old Road, Uk, M6 7AF</span><span
                                                                                class="service-list">+44 235 856843</span><span
                                                                                class="service-list">+44 235 856843</span><span
                                                                                class="service-list">admin@company
                                                                            .com</span>
                                                                        <a href="#"><span class="tg-show"><em
                                    ...
                                    <div class="col-xs-12 col-md-8 builder-column ">
                                        <div class="sc-contact-form">
                                            <div class="tg-refinesearcharea contact_wrap">
                                                ...
                                                <fieldset>
                                                    <div class="row form-data" data-success="Message Sent."
                                                         data-error="Message Fail." data-email="">
